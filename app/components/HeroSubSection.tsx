    ...
    <div className="flex flex-col space-y-10 my-10">
      <div className="max-w-2xl space-y-6">
        <h1 className="text-5xl font-bold">
          Effortlessly Manage Your Finances with Ease
        </h1>
        <p className="text-xl font-light text-left max-w-5/6">
          Using Expense Tracker is simple and intuitive. Just input your income
          and expenses to see your savings visually represented.
        </p>
      </div>
      ...
      <div className="space-x-5">
        ...
        <Link href="/about">
          <button className="text-green-800 px-6 py-2 cursor-pointer">{`Learn More >`}</button>
        </Link>
      </div>
    </div>
  );
