...
const LogInForm = () => {
  ...
  return (
    <form
      ...
      } rounded-lg shadow-md px-8 py-10 m-6 w-full max-w-md mx-auto space-y-6 transition duration-1000`}
      onSubmit={handleBtnOnSubmit}
    >
      <h2 className="text-center text-4xl mb-10 font-bold">Login</h2>
      <div>
        <label className="block text-sm font-mediummb-2">Username</label>
        <input
          type="text"
      ...
      <div>
        ...
        <div className="relative">
          ...
          />
          <button
            className="absolute right-2 top-1/2 mr-1.5   transform -translate-y-1/2 text-sm text-green-500 cursor-pointer"
      ...
      <div className="flex justify-center">
        <button
          ...
          className={`w-auto px-4 py-2 ${
            isDark ? 'bg-green-800 hover:bg-green-900' : 'bg-green-600 hover:bg-green-700'
