    ...
    <>
      {isLoading ? (
        ...
        <form
          ...
          className={`${isDark ? 'bg-green-950' : 'bg-green-200'} rounded-lg shadow-md p-6 m-4 w-auto max-w-lg mx-auto
        ...
        >
          ...
          <div className="flex justify-center gap-5">
            ...
            <button
              type="button"
              className="bg-green-500 text-white w-fit p-2 rounded cursor-pointer hover:bg-green-600 transition duration-200"
